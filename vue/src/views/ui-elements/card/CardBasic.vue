...
<template>
    <div id="demo-basic-card">
        <div class="vx-row">
            ...
            <!-- CONTENT CARD - ICONS -->
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card :title="card_10.title" :subtitle="card_10.subtitle">
                    <template slot="actions">
                        <feather-icon icon="MoreVerticalIcon" svgClasses="w-6 h-6 text-grey"></feather-icon>
                    </template>
                    <img :src="card_10.img" alt="content-img" class="responsive rounded-lg">
